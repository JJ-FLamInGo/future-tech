  ...
  onKeyDown = (event) => {
    ...
    const action = {
      ...
      End: this.lastTab,
		...
		// Оператор опциональной последовательности ?. - код выполнит автоматическую проверку. Если action не undefined, то вызовится соответствующий метод (), в ином случае ничего не произойдет.
		action?.()
  };
